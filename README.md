...
UC-04. **主揪團購訂單管理**:
   已完成
   - 任何人皆可輸入「團購名稱」、「群組公告（選填）」、「截止時間（選填）」及「管理者密碼」後發起團購。
   - 左側列表動態顯示所有進行中的團購名稱。
   - 點擊團購顯示團購的"團購名稱"、"公告"、"團購時限"。
   - 點擊"結束團購"按鈕 -> 要求輸入管理者密碼
   - 點擊"輸出訂單明細總表"按鈕 -> 要求輸入管理者密碼 -> 顯示訂單明細
   - 在還沒結束團購前，點擊"輸出訂單明細總表"按鈕會顯示團購尚未結束
   - 預設每筆訂單皆有三筆商品(等做UC-05 記得去 GroupOrder 的建構子移除)
   - 編輯公告
   - 團購時限結束自動結束團購
   - 結束團購後將該團購移至"已結單的團購"
   - 新增共同管理人 (主糾跟共同管理人講管理者密碼就好)
